...
contract DeployTVLOracleScript is Script {
    ...
    function writeSuiteVersionFile() internal {
        ...
        string memory versionString = vm.readLine("release/logs/TVLOracle/optimism/version.txt");
        ...
        vm.writeFile(
            "release/logs/TVLOracle/optimism/version.txt",
        ...
        vm.writeFile(
            string(
                abi.encodePacked(
                    "release/logs/TVLOracle/optimism/",
