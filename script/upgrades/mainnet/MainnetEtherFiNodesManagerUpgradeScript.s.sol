        ...
        vm.writeFile(
            ...
            string(
                abi.encodePacked(
                    ...
                    "\nOptional Comments: ", 
                    "The current 'processNodeExit' function does not take into account duplicate exits, we fixed this by adding a require to make sure the validator is in the LIVE phase"
                )
            )
        );
    }
