...
contract LiquidityPoolUpgrade is Script {
    ...
    function writeUpgradeVersionFile() internal {
        ...
        string memory localVersionString = vm.readLine("release/logs/Upgrades/mainnet/LiquidityPool/version.txt");
        ...
        vm.writeFile(
            "release/logs/Upgrades/mainnet/LiquidityPool/version.txt",
        ...
        vm.writeFile(
            string(
                abi.encodePacked(
                    "release/logs/Upgrades/mainnet/LiquidityPool/",
