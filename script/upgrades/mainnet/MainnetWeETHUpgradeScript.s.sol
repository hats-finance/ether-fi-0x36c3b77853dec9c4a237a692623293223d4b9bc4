...
contract WeEthUpgrade is Script {
    ...
    function writeUpgradeVersionFile() internal {
        ...
        string memory localVersionString = vm.readLine("release/logs/Upgrades/mainnet/WeETH/version.txt");
        ...
        vm.writeFile(
            "release/logs/Upgrades/mainnet/WeETH/version.txt",
        ...
        vm.writeFile(
            string(
                abi.encodePacked(
                    "release/logs/Upgrades/mainnet/WeETH/",
