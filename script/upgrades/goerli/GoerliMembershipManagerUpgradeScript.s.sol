...
contract MembershipManagerUpgrade is Script {
    ...
    function writeUpgradeVersionFile() internal {
        ...
        string memory localVersionString = vm.readLine("release/logs/Upgrades/goerli/MembershipManager/version.txt");
        ...
        vm.writeFile(
            "release/logs/Upgrades/goerli/MembershipManager/version.txt",
        ...
        vm.writeFile(
            string(
                abi.encodePacked(
                    "release/logs/Upgrades/goerli/MembershipManager/",
