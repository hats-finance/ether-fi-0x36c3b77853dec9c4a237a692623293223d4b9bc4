...
contract ScenarioTest is Test {
    ...
    function testOneBidderWithOneStake() public {
        ...
        (,,,, bool isActive2) = auctionInstance.auctions(auctionInstance.numberOfAuctions() - 1);
    ...
    function testTwoBidderWithOneStakeAndRefundForLosingBidder() public {
        ...
        (uint256 winningBidIdAfterBid1, uint256 numberOfBidsAfterBid1,,, bool isActiveAfterBid1) = auctionInstance.auctions(auctionInstance.numberOfAuctions() - 1);
        (uint256 amountOfBid1,, address bidderAddressAfterBid1) = auctionInstance.bids(auctionInstance.numberOfAuctions() - 1, winningBidIdAfterBid1);

        assertEq(winningBidIdAfterBid1, 0);
        assertEq(numberOfBidsAfterBid1, 1);
        assertEq(amountOfBid1, 0.1 ether);
        assertEq(bidderAddressAfterBid1, 0xCd5EBC2dD4Cb3dc52ac66CEEcc72c838B40A5931);
        ...
        (uint256 winningBidIdAfterBid2, uint256 numberOfBidsAfterBid2,,, bool isActiveAfterBid2) = auctionInstance.auctions(auctionInstance.numberOfAuctions() - 1);
        (uint256 amountOfBid2,, address bidderAddressAfterBid2) = auctionInstance.bids(auctionInstance.numberOfAuctions() - 1, winningBidIdAfterBid2);
        ...
        assertEq(bidderAddressAfterBid2, 0xCDca97f61d8EE53878cf602FF6BC2f260f10240B);

        depositInstance.deposit{value: 0.1 ether}();
        assertEq(TestBNFTInstance.ownerOf(0), 0xCDca97f61d8EE53878cf602FF6BC2f260f10240B);
        assertEq(TestTNFTInstance.ownerOf(0), 0xCDca97f61d8EE53878cf602FF6BC2f260f10240B);
        assertEq(address(depositInstance).balance, 0.1 ether);
        assertEq(auctionInstance.refundBalances(0xCd5EBC2dD4Cb3dc52ac66CEEcc72c838B40A5931), 0.1 ether);

        (,,,, bool isActiveAfterStake) = auctionInstance.auctions(auctionInstance.numberOfAuctions() - 1);
        ...
        assertEq(auctionInstance.refundBalances(0xCd5EBC2dD4Cb3dc52ac66CEEcc72c838B40A5931), 0);
        assertEq(auctionInstance.refundBalances(0xCDca97f61d8EE53878cf602FF6BC2f260f10240B), 0);
        assertEq(address(depositInstance).balance, 0.1 ether);
