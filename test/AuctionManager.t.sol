...
contract AuctionManagerTest is Test {
    ...
    function test_CreateBidChangesCurrentHighestBid() public {
        bytes32[] memory proof = merkle.getProof(whiteListedAddresses, 0);
        ...
        hoax(bob);
        uint256 bid3Id = auctionInstance.createBid{value: 0.5 ether}(proof);
        highestBidId = auctionInstance.currentHighestBidId();
        assertEq(highestBidId, bid2Id);
    }
