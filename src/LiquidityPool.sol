...
contract LiquidityPool is Initializable, OwnableUpgradeable, UUPSUpgradeable, ILiquidityPool {
    ...
    function initializePhase2(uint128 _schedulingPeriod, uint32 _numEethValidators, uint32 _numEtherFanValidators) external onlyOwner {        
        schedulingPeriodInSeconds = _schedulingPeriod;

        fundStatistics[SourceOfFunds.EETH].numberOfValidators = _numEethValidators;
        fundStatistics[SourceOfFunds.ETHER_FAN].numberOfValidators = _numEtherFanValidators;
    }
