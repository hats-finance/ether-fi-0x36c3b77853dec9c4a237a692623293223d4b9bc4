...
contract EtherFiNode is IEtherFiNode {
    ...
    ///
    /// Note that since the execution layer does not have the access to the consensus layer data
    /// such as the status and balance of the validator, therefore the partial withdrawal
    /// assumes that the validator is in active & not being slashed + the beacon balance is 32 ether.
